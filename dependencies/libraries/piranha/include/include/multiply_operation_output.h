#ifndef PIRANHA_MULTIPLY_OPERATION_OUTPUT_H
#define PIRANHA_MULTIPLY_OPERATION_OUTPUT_H
...
namespace piranha {
    ...
    class MultiplyOperationNodeOutput : public FundamentalOutput<Type> {
    public:
        MultiplyOperationNodeOutput() {
            /* void */
        }

        virtual ~MultiplyOperationNodeOutput() {
            /* void */
        }
...
#endif /* PIRANHA_MULTIPLY_OPERATION_OUTPUT_H */
