...
manta::SSCameraRayEmitterGroup::SSCameraRayEmitterGroup() {
}

manta::SSCameraRayEmitterGroup::~SSCameraRayEmitterGroup() {
}

void manta::SSCameraRayEmitterGroup::createAllEmitters() {
	...
	for (int i = 0; i < m_resolutionY; i++) {
		for (int j = 0; j < m_resolutionX; j++) {
			SSCameraRayEmitter *newEmitter = createEmitter<SSCameraRayEmitter>();
